                ...
                <div>
                    <div className="ml-10">
                        ...
                        <select name="Galaxy" onChange={onChoice}>
                            ...
                            <option value="GALAXY S21 PLUS" label="GALAXY S21 PLUS"></option>
                            <option value="GALAXY S21 ULTRA" label="GALAXY S21 ULTRA"></option>
                            <option value="GALAXY S22 " label="GALAXY S22 "></option>
                            <option value="GALAXY S22 PLUS" label="GALAXY S22 PLUS"></option>
                            <option value="GALAXY S22 ULTRA" label="GALAXY S22 ULTRA"></option>
                            <option value="GALAXY NOTE 20" label="GALAXY NOTE 20"></option>
                            <option value="GALAXY NOTE 20 ULTRA" label="GALAXY NOTE 20 ULTRA"></option>
                            <option value="GALAXY Z FLIP 3" label="GALAXY Z FLIP 3"></option>
                            <option value="GALAXY Z FLIP 4" label="GALAXY Z FLIP 4"></option>
                            <option value="GALAXY Z FOLD 4" label="GALAXY Z FOLD 4"></option>
                            <option value="GALAXY Z FOLD 4" label="GALAXY Z FOLD 4"></option>
                        </select> : null}
                    </div>
                    <button className="my-7 mx-20 ml-[100px] py-5 px-14 bg-green-300 items-center" onClick={consoleAA}>주문하기</button>
                </div>
